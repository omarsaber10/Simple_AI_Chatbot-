...
A smart conversational AI powered by **Llama 3.3-70b** (via Groq API), wrapped in a custom **Batman-themed dark UI** built with Streamlit. Fast. Intelligent. Dark.
...
<p align="center">
  <i>Built with ❤️ and a little Gotham darkness</i>
</p>
